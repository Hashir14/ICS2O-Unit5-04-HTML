...
function image () {
  ...
  document.getElementById('change-text').innerHTML = 'I guess not. I figured you were more of a cat person'
}
...
function puns () {
  ...
  document.getElementById('change-text').innerHTML = 'Sorry about that. I was just <i>kitten</i> around. But I guess that comment was a little <i>ruff</i>. All puns intended.'
}
